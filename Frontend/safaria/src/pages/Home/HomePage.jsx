...
import { MapPin, Palette, Home as HomeIcon, Tent, Users, Star, Globe, Heart, TrendingUp, Award } from 'lucide-react';
      ...
      <PageContainer>
        ...
        <section className="py-20 relative z-10">
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-bold text-center mb-16 text-gray-800"
          >
            {t(language, 'home.gallery.title')}
          </motion.h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              '/images/WhatsApp Image 2025-11-23 at 6.09.10 PM.jpeg',
              '/images/WhatsApp Image 2025-11-23 at 6.09.11 PM.jpeg',
              '/images/WhatsApp Image 2025-11-23 at 6.09.11 PM (1).jpeg',
              '/images/WhatsApp Image 2025-11-23 at 6.09.11 PM (2).jpeg',
              '/images/WhatsApp Image 2025-11-23 at 6.09.12 PM.jpeg',
              '/images/WhatsApp Image 2025-11-23 at 6.09.12 PM (1).jpeg',
              '/images/WhatsApp Image 2025-11-23 at 6.09.13 PM.jpeg',
              '/images/WhatsApp Image 2025-11-23 at 6.09.13 PM (1).jpeg'
            ].map((url, idx) => (
              <motion.div
                key={idx}
